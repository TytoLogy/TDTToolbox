function [resp, index] = headphonecal_io(iodev, stim_lr, inpts)
% [resp, index] = headphonecal_io(iodev, stim_lr, inpts)
%
...
% 
% Output Arguments:
%	resp		{1X3} cell array, L = 1, R = 2, (REF B&K or input) = 3
% 	index		buffer index
% 
...
% resp{3} = double(invoke(iodev.C, 'ReadTagV', 'data_inREF', 0, inpts));
