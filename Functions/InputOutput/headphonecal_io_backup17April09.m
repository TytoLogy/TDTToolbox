...
index(1) = RPgettag(iodev, 'index_in1');
index(2) = RPgettag(iodev, 'index_in2');
index(3) = RPgettag(iodev, 'index_in3');
sprintf('L index out = %d', RPgettag(iodev, 'index_outL'))
sprintf('R index out = %d', RPgettag(iodev, 'index_outR'))
