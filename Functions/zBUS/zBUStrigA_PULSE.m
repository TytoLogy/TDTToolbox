function status = zBUStrigA_PULSE(zBUS, racknum, delayms)
%------------------------------------------------------------------------
...
%------------------------------------------------------------------------
% 
% Pulses (on for one cycle) zBUS trigger A
% 
%------------------------------------------------------------------------
% Input Arguments:
...
% results.
%------------------------------------------------------------------------
% See Also: zBUSTrigA, zBUSinit, zBUSclose, zBUSTrigA_ON, zBUSTrigA_OFF
%------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	status = zBUS.C.zBusTrigA(racknum, 0, delayms);
